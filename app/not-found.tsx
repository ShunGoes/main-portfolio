    ...
    <body className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-0 relative">      
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          ...
          <Button 
            variant="outline" 
            className="w-full sm:w-auto border-secondary text-secondary hover:bg-secondary hover:text-white flex items-center gap-2"
        ...
        <div className="mt-6 pt-8 border-t border-gray-200">
          ...
          <div className="flex flex-wrap justify-center gap-4 text-sm">
            ...
            <Link href="/visit-us" className="text-primary hover:text-primary/80 font-medium">
              Visit Us
            </Link>
            <Link href="/sermons" className="text-primary hover:text-primary/80 font-medium">
              Sermons
            </Link>
          </div>
        </div>
